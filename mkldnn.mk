...
ifneq ($(CPU_TARGET_ARCH),)
  ARCH_OPT_FLAGS=-mtune=$(CPU_TARGET_ARCH) -march=$(CPU_TARGET_ARCH)
else
  ARCH_OPT_FLAGS=
endif
...
$(MKLDNN_LIBFILE):
	...
	cmake $(MKLDNN_SUBMODDIR) -DCMAKE_INSTALL_PREFIX=$(MKLDNNROOT) -B$(MKLDNN_BUILDDIR) -DARCH_OPT_FLAGS="$(ARCH_OPT_FLAGS)" -DWITH_TEST=OFF -DWITH_EXAMPLE=OFF
