...
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/usr/local/cuda/lib64/stubs/:/usr/local/cuda-9.2/lib64/stubs/

echo " LD_LIBRARY_PATH ==== ${LD_LIBRARY_PATH}"

ln -s /usr/local/cuda/lib64/stubs/libcuda.so /usr/local/cuda/lib64/stubs/libcuda.so.1
ln -s /usr/local/cuda-9.2/lib64/stubs/libcuda.so /usr/local/cuda-9.2/lib64/stubs/libcuda.so.1
