...
const static bool ngraph_gluon_enable = dmlc::GetEnv("MXNET_NGRAPH_GLUON", false);

// logging
const static bool ngraph_log_verbose = dmlc::GetEnv("MXNET_NGRAPH_VERBOSE", false);
const static bool ngraph_log_graph = dmlc::GetEnv("MXNET_NGRAPH_VERBOSE_GRAPH", false);
const static bool ngraph_log_viz = dmlc::GetEnv("MXNET_NGRAPH_VERBOSE_VIZ", false);
const static bool ngraph_log_timer = dmlc::GetEnv("MXNET_NGRAPH_TIMER", false);
const static bool ngraph_log_verbose_detail =
